...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Society ERP — Housing Society Management System"
        description="Run your cooperative housing society end-to-end. Manage members, track maintenance payments, resolve complaints, post notices, and chat with residents in real time."
        path="/"
      />
      {/* Hero Section */}
      <header className="sidebar-gradient min-h-screen flex items-center relative overflow-hidden" role="banner">
            ...
            <div className="flex items-center gap-3 mb-8 animate-fade-in">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">
                  Society ERP
                  <span className="sr-only"> — Housing Society Management System</span>
                </h1>
