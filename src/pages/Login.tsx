...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      <Seo
        title="Sign In | Society ERP — Housing Society Management"
        description="Sign in to your Society ERP account to manage members, maintenance payments, complaints, notices, and chat with society management."
        path="/login"
        noindex
      />
      {/* Left Panel - Hero */}
