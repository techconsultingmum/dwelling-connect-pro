...
CREATE POLICY "Users can mark received messages as read" ON public.messages FOR UPDATE TO authenticated USING (auth.uid() = receiver_id);
...
-- =============================================
-- FIX 3: Seed default society settings if empty
-- =============================================
